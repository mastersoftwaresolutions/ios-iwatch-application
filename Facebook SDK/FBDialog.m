...
- (void)dialogDidSucceed:(NSURL *)url {
	NSRange r = [[NSString stringWithFormat:@"%@", url] rangeOfString:@"fbconnect://success/?post_id=" options:NSCaseInsensitiveSearch];
	if(r.length > 0) {
		[[NSNotificationCenter defaultCenter] postNotificationName:@"Posted_Successfully" object:nil];
	}
